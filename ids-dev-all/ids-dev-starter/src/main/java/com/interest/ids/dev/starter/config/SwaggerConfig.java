package com.interest.ids.dev.starter.config;
...
public class SwaggerConfig extends WebMvcConfigurerAdapter {
    ...
    @Bean
    public Docket api() {
        return new Docket(DocumentationType.SWAGGER_2).groupName("dev").select() // 选择那些路径和api会生成document
                .apis(RequestHandlerSelectors.withMethodAnnotation(ApiOperation.class))
                .paths(PathSelectors.any()) // 对所有路径进行监控
                .build().apiInfo(devApiInfo());
    }
