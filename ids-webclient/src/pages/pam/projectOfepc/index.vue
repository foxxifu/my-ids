    ...
    <el-container>
      ...
      <el-main style="padding-top: 5px">
        <el-table :data="tableData" border :size="elementSize" @select="select" :fit="true">
          ...
          <el-table-column prop="projectPic" label="项目图片" align="center">
            <template slot-scope="scope">
          ...
          <el-table-column prop="schedule" label="项目进度" align="center">
            <template slot-scope="scope">
          ...
          <el-table-column prop="endTime" label="截止时间" align="center" :width="150">
          </el-table-column>

          <el-table-column prop="status" label="项目状态" align="center">
          </el-table-column>

          <el-table-column prop="charge" label="负责人" align="center" :width="150">
          </el-table-column>
