<template>
  <el-container id="statisticsOfepc">
    ...
    <el-main style="margin-top: 10px;padding-top: 0;">
      ...
      <el-tabs v-model="inverterInfo"  @tab-click="tabClick">
        <el-tab-pane label="逆变器发货量排行" name="shipments" >
          ...
          <el-row style="line-height: 32px;margin-bottom: 5px;">
            <el-col :span="24">
              ...
              <div style="float: right" ><el-button type="primary" :size="elementSize">导出</el-button></div>
            </el-col>
          </el-row>
        ...
        <el-tab-pane label="发货量统计" name="consignmentOfInverter">
          ...
          <el-table :data="consignmentOfInverterTableData" :size="elementSize" ref="consignmentOfInverterTable" border>
          ...
          <el-pagination :current-page="1" :page-sizes="[10, 20, 30, 50]" :page-size="10"
                         layout="total, sizes, prev, pager, next, jumper" :total="10" style="float: right; margin-top: 5px;">
          </el-pagination>
