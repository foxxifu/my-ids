<template>
  ...
  <el-container v-if="isShowMain" style="height: 100%;" id="exchangeOfGoodsOfepc">
        ...
        <el-tabs v-model="returnState" type="border-card" style="height: 500px">
          <el-tab-pane label="申请中" name="applying">
            ...
            <el-table :data="applyingTableData" :size="elementSize" ref="applyingTable" border>
              ...
              <el-table-column prop="installationDate" label="安装日期" align="center">
              </el-table-column>
              ...
              <el-table-column label="操作" align="center">
                <template slot-scope="scope">
                  <el-button @click="" type="text" style="color: red">撤回</el-button>
                </template>
              </el-table-column>
            ...
            <el-table :data="refusedTableData" :size="elementSize" ref="refusedTable" border>
              ...
              <el-table-column label="操作" align="center">
                <template slot-scope="scope">
                  ...
                  <el-button @click="rejectionDelRow(scope.$index, refusedTableData)" type="text" style="color: red">删除
                  </el-button>
                </template>
              </el-table-column>
    ...
    <el-dialog :title="exchangeForm.title" :visible.sync="isShowExchangeDialog">
      <el-form :model="exchangeForm" ref="exchangeForm" :inline="true" :size="elementSize"
               label-position="left" label-width="100px" :disabled="exchangeFormDisabledFlag">
        ...
        <el-row>
          ...
          <el-col :span="12">
            <el-form-item label="设备型号" prop="devVersion">
              <el-input v-model="exchangeForm.devVersion"></el-input>
            </el-form-item>
          </el-col>
        </el-row>
        ...
        <el-row>
          <el-col :span="12">
            <el-form-item label="生产日期">
              <el-date-picker style="width: 180px" v-model="exchangeForm.productionDate" type="date"
                              placeholder="选择日期"></el-date-picker>
            </el-form-item>
          </el-col>
          <el-col :span="12">
            <el-form-item label="发货日期">
              <el-date-picker style="width: 180px" v-model="exchangeForm.deliveryDate" type="date"
                              placeholder="选择日期"></el-date-picker>
            </el-form-item>
          </el-col>
        </el-row>
        ...
        <el-row>
          <el-col :span="12">
            <el-form-item label="设备状态" prop="devStatus">
              <el-select style="width: 180px" v-model="exchangeForm.devStatus" placeholder="请选择">
                <el-option v-for="item in options" :key="item.value" :label="item.label" :value="item.value">
                </el-option>
              </el-select>
            </el-form-item>
          ...
          <el-col :span="12">
            <el-form-item label="ESN号" prop="esnNum">
              <el-input v-model="exchangeForm.esnNum"></el-input>
            </el-form-item>
          </el-col>
        </el-row>
        ...
        <el-row>
          <el-col :span="12">
            <el-form-item label="代理商" prop="agent">
              <el-input v-model="exchangeForm.agent"></el-input>
            </el-form-item>
          </el-col>
          <el-col :span="12">
            <el-form-item label="设备类型">
              <el-input v-model="exchangeForm.devType"></el-input>
            </el-form-item>
          </el-col>
        </el-row>
        ...
        <el-row>
          <el-col :span="12">
            <el-form-item label="安装日期">
              <el-date-picker style="width: 180px" v-model="exchangeForm.installationDate" type="date"
                              placeholder="选择日期"></el-date-picker>
            </el-form-item>
          </el-col>
          <el-col :span="12">
            <el-form-item label="安装点">
              <el-input v-model="exchangeForm.installationSite"></el-input>
            </el-form-item>
          </el-col>
        </el-row>
        ...
        <el-row>
          <el-col :span="12">
            <el-form-item label="所属电站">
              <el-input v-model="exchangeForm.powerStation"></el-input>
            </el-form-item>
          </el-col>
          <el-col :span="12">
            <el-form-item label="质保时间">
              <el-input v-model="exchangeForm.warrantyTime"></el-input>
            </el-form-item>
          </el-col>
        </el-row>
        ...
        <el-row>
          <el-col :span="24">
            <el-form-item label="换机原因">
              <el-input v-model="exchangeForm.exchangeReason" type="textarea"></el-input>
            </el-form-item>
          </el-col>
        </el-row>
        ...
        <el-row>
          <el-col :span="24">
            <el-form-item label="申请附件">
              <el-input v-model="exchangeForm.attachment"></el-input>
            </el-form-item>
          </el-col>
        </el-row>
        ...
        <el-row>
          <el-col :span="12">
            <el-form-item label="申请人">
              <el-input v-model="exchangeForm.applicant"></el-input>
            </el-form-item>
          </el-col>
          <el-col :span="12">
            <el-form-item label="申请时间">
              <el-input v-model="exchangeForm.applicationDate"></el-input>
            </el-form-item>
          </el-col>
        </el-row>

        <el-row v-if="exchangeForm.showApprovalInfo">
          <el-col :span="24">
            <el-form-item label="审批意见">
              <el-input v-model="exchangeForm.approvalOpinion"></el-input>
            </el-form-item>
          </el-col>
        </el-row>
        ...
        <el-row v-if="exchangeForm.showApprovalInfo">
          <el-col :span="12">
            <el-form-item label="审批人">
              <el-input v-model="exchangeForm.approver"></el-input>
            </el-form-item>
          </el-col>
          <el-col :span="12">
            <el-form-item label="审批时间">
              <el-input v-model="exchangeForm.approvalTime"></el-input>
            </el-form-item>
          </el-col>
        </el-row>
      ...
      <div slot="footer" class="dialog-footer" style="text-align: center">
        <el-button type="primary" :size="elementSize" @click="isShowExchangeDialog = false" v-if="exchangeForm.showConfirmBtn">确定</el-button>
        <el-button type="danger" :size="elementSize" v-if="exchangeForm.showWithdrawalBtn">撤回申请</el-button>
        <el-button type="primary" :size="elementSize" v-if="exchangeForm.showSaveBtn">保存并提交申请</el-button>
        <el-button :size="elementSize" @click="isShowExchangeDialog = false" v-if="exchangeForm.showReturnBtn">返回</el-button>
      </div>
    </el-dialog>
    ...
    <el-main style="padding-top: 5px">
      <el-row >
        <el-col :span="12" style="float: left">
          ...
          <i class="el-icon-plus" v-if="exchangeForm.titleType == 4">新增</i>
        </el-col>
        <el-col :span="12">
        ...
        <el-table :data="exchangeTableData" :size="elementSize" ref="exchangeTableData" border :show-header="false"
          ...
          <el-table-column prop="kpiName1" label="kpi名称" align="center">
            <template slot-scope="scope">
              ...
              <div v-else-if="scope.$index === 3"><span>安装日期</span></div>
              <div v-else-if="scope.$index === 4"><span>安装地点</span></div>
              <div v-else-if="scope.$index === 5"><span>所属电站</span></div>
              <div v-else-if="scope.$index === 6"><span>换机原因</span></div>
              <div v-else-if="scope.$index === 7"><span>申请附件</span></div>
              <div v-else-if="scope.$index === 8"><span>申请人</span></div>
              <div v-else-if="scope.$index === 9"><span>审批意见</span></div>
              <div v-else-if="scope.$index === 10"><span>审批人</span></div>
            </template>
          </el-table-column>
          ...
          <el-table-column prop="kpiValue1" label="kpi值" align="left">
            <template slot-scope="scope">
              ...
              <!--<el-form-item v-else-if="scope.$index === 3" prop="epc">
                ...
                <el-button v-else type="text">{{exchangeForm.epc}}</el-button>
              </el-form-item>-->

              <el-form-item v-else-if="scope.$index === 3" prop="installationDate">
              ...
              <el-form-item v-else-if="scope.$index === 4" prop="installationSite">
              ...
              <el-form-item v-else-if="scope.$index === 6" prop="exchangeReason">
              ...
              <el-form-item v-else-if="scope.$index === 7" prop="attachment">
              ...
              <el-form-item v-else-if="scope.$index === 8" prop="applicant">
              ...
              <el-form-item v-else-if="scope.$index === 10" prop="applicant">
                ...
                <span v-else >{{exchangeForm.approver}}</span>
              </el-form-item>
          ...
          <el-table-column prop="kpiName2" label="kpi名称" align="center">
            <template slot-scope="scope">
              <div v-if="scope.$index === 0" :class="exchangeFormDisabledFlag ? '' : 'self-is-required'"><span>设备型号</span></div>
              ...
              <div v-else-if="scope.$index === 8"><span>申请时间</span></div>
              <div v-else-if="scope.$index === 9"><span></span></div>
              <div v-else-if="scope.$index === 10"><span>审批时间</span></div>
            </template>
          </el-table-column>
          ...
          <el-table-column prop="kpiValue2" label="kpi值" align="left">
            <template slot-scope="scope">
              ...
              <!--<el-form-item v-else-if="scope.$index === 5" prop="ratedOutputPower">
                ...
                <el-button v-else type="text">{{exchangeForm.ratedOutputPower}}</el-button>
              </el-form-item>-->
              ...
              <el-form-item v-else-if="scope.$index === 5" prop="warrantyTime">
                ...
                <span v-else type="text">{{exchangeForm.warrantyTime}}</span>
              </el-form-item>

              <el-form-item v-else-if="scope.$index === 6">
              </el-form-item>

              <el-form-item v-else-if="scope.$index === 7">
              </el-form-item>

              <el-form-item v-else-if="scope.$index === 8" prop="warrantyTime">
              ...
              <el-form-item v-else-if="scope.$index === 9">
              </el-form-item>

              <el-form-item v-else-if="scope.$index === 10" prop="approvalTime">
