...
<template>
  <div class='dev-alarm'>
    ...
    <div class="list-bar">
      <div class="list-table">
        <el-table :data="list" ref="devAlarmTable" :maxHeight="maxHeight" border width="100%" :fit="fit" row-key="id"
          ...
          <el-table-column fixed prop="stationName" :label="$t('io.alarm.plantName')" align="center">
          </el-table-column>
    ...
    <!-- 转工单的的对话框 -->
    <AddDefectDialog v-if="isShowAddDefect" :is-show-add-defect.sync="isShowAddDefect" :rowDatas="addDefectFormData" :alarmType="1"></AddDefectDialog>
  </div>
</template>
