      ...
      <el-tab-pane :label="$t('station.equipment.devMonitor')"><!-- 设备监控 -->
        <el-row style="margin: 30px 0px 60px 0px;">
          <el-col :span="4">
            ...
            <div class="dev_name">电表</div>-->
            <div style="text-align: center">
              <img src="/assets/images/station/electricMeter.png">
              <div>{{$t('station.equipment.devMeter')}}</div><!-- 电表 -->
            </div>
          </el-col>
          <el-col :span="20">
            <el-table :data="devStatusTableData" ref="devStatusTableData" border :show-header="false" :highlight-current-row="false"
              ...
              <el-table-column prop="kpiValue4" :label="$t('station.kpiValue')" align="right" class-name="kpiName"></el-table-column>
            </el-table>
          </el-col>
        </el-row>
      </el-tab-pane>
